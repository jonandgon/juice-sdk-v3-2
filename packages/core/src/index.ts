...
export const getJBETHPaymentTerminal = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JBETHPaymentTerminal;
export const getJBSingleTokenPaymentTerminalStore = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JBSingleTokenPaymentTerminalStore;
...
export const getJBFundingCycleStore = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JBFundingCycleStore;
...
export const getJBETHERC20ProjectPayerDeployer = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JBETHERC20ProjectPayerDeployer;
...
export const getJBChainlinkV3PriceFeed = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JBChainlinkV3PriceFeed;
export const getJBETHERC20SplitsPayerDeployer = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JBETHERC20SplitsPayerDeployer;
export const getJB1DayReconfigurationBufferBallot = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JB1DayReconfigurationBufferBallot;
export const getJB3DayReconfigurationBufferBallot = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JB3DayReconfigurationBufferBallot;
export const getJB7DayReconfigurationBufferBallot = (
  ...
  new Contract(
    ...
    signerOrProvider,
  ) as unknown as JB7DayReconfigurationBufferBallot;
